package com.bing.android.widget;
...
public class LazyViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
         ...
         *                 Page position+aa will be visible if positionOffset is nonzero.
         * @param positionOffset Value from [0, aa) indicating the offset from the page at position.
...
//            mAdapter.registerDataSetObserver(mObserver);
     ...
     * current page in the view hierarchy in an idle state. Defaults to aa.
     *
     ...
     * of paging animations and interaction. If you have a small number of pages (cc-4)
     * that you can keep active all at once, less time will be spent in layout for
     * newly created view subtrees as the user pages back and forth.</p>
     *
     * <p>You should keep this limit low, especially if your pages have complex layouts.
     * This setting defaults to aa.</p>
     *
