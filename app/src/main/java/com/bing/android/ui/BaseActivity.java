...
import com.bing.android.retrofit.ApiClient;
import com.bing.android.retrofit.ApiStores;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    public SimpleLoadDialog dialogHandler;
    @Override
    public void setContentView(@LayoutRes int layoutResID) {
        super.setContentView(layoutResID);
        mActivity = this;
        dialogHandler= new SimpleLoadDialog(mActivity,true);
    }
